...
public class ChessBoard
{
	...
	public static final char MARK_1 = '\uE310'; // 1 left of left margin
	public static final char MARK_A_BELOW = '\uE318'; // a below bottom margin
    ...
    public void printBoard()
    {
        for (int i = 0; i < board.length; i++)
        {
            ...
            System.out.print((char)(MARK_1 + (char)7 - (char)i));
		...
		System.out.print(' ');
		for (int i=0; i < 8; ++i)
           System.out.print((char)(MARK_A_BELOW + (char)i));
    }
